...
*---------------------------------------------------------------*/
void compCorr(float *cc, float *gc, float *pm, float *buffer,
              int lag, int bLen, int sRange)
{
    int i;
...
*---------------------------------------------------------------*/
void doThePLC(float *PLCresidual, float *PLClpc, int PLI, float *decresidual, 
              float *lpc, int inlag, iLBC_Dec_Inst_t *iLBCdec_inst)
{
    int lag = 20, randlag;
    float gain, maxcc;
    float use_gain;
