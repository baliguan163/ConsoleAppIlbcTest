...
void filteredCBvecs(float *cbvectors, float *mem, int lMem)
{
    ...
    /* Create codebook vector for higher section by filtering do filtering */
    pos = cbvectors;
...
*----------------------------------------------------------------*/
void searchAugmentedCB(int low, int high, int stage, int startIndex, float *target, float *buffer, 
                       float *max_measure, int *best_index, float *gain, float *energy, float *invenergy)
{
